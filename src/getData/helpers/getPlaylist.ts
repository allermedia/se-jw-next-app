...
const updateThumbnailToConfig = (mediaID: string, file = '', enableMovingThumbnail = false, startAtTime = '') => {
...
export default function getPlaylist(mediaID: string, file='', enableMovingThumbnail = false, startAtTime = '') {
